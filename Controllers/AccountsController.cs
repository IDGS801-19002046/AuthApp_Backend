    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<ActionResult<AuthResponseDto>> RefreshToken(TokenDto tokenDto)
        {
            ...
            if (string.IsNullOrEmpty(tokenDto.Token) || string.IsNullOrEmpty(tokenDto.Email))
            {
                ...
                {
                    IsSuccess = false,
                    Message = "Token o email estan vacios."
                });
            }
            ...
            return Ok(new AuthResponseDto
            {
                ...
                Message = "Token refrescado satisfactoriamente "
            });
        ...
        private ClaimsPrincipal? GetPrincipalFromExpiredToken(string token)
        {
            ...
            {
                throw new ArgumentNullException(nameof(token), "No existe token o esta vacio.");
            }
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordDto forgotPasswordDTO)
        {
            ...
            if (response.IsSuccessful)
            {
                ...
                {
                    IsSuccess = true,
                    Message = "Email enviado con el password de verificacion"
                });
            }
            else
            {
        ...
        public async Task<IActionResult> ResetPassword(ResetPasswordDto resetPasswordDto)
        {
            ...
            if (result.Succeeded)
            {
                ...
                {
                    IsSuccess = true,
                    Message = "Contraseña reseatada correctamente"
                });
            }
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordDto changePasswordDto)
        {
            ...
            if (user is null)
            {
                ...
                {
                    IsSuccess = false,
                    Message = "No existe usaurio registrado con este email"
                });
            }
